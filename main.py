...
def main(args):
    ...
    train_dataset = TextDataset(vocab, os.path.join(args.root_dir, 'training_label.txt'))
    train_loader = DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True, num_workers=2, pin_memory=True, collate_fn=PadCollate(args.batch_size))
